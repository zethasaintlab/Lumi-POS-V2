...
- [ ] **Kepemilikan database lokal belum diputuskan — MEMBLOKIR seluruh sisi klien F2.** **Performa sudah dicoret sebagai pertimbangan** (diukur 7 Agu 2026, `prototypes/03-sqlite-opfs/FINDINGS.md` §5b): VFS PowerSync (`OPFSCoopSyncVFS`) justru **sedikit lebih cepat** — 3,25 ms vs 3,97 ms per penjualan. Yang tersisa sebagai selisih hanya ukuran WASM (1,12 MB vs 865 kB). Dua pertanyaan yang **belum** terjawab dan menentukan: (1) apakah PowerSync mengizinkan SQL sembarang dengan transaksi yang KITA kendalikan — invariant #1 menuntutnya; (2) apakah skema 20 tabel kami dapat hidup berdampingan dengan tabel internal PowerSync. Keputusan pemilik produk — ia menyentuh stack terkunci
