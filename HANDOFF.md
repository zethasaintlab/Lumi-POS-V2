...
- [ ] **`tax_rate.rate` turun sebagai `numeric` PostgreSQL ke kolom `INTEGER` lokal.** Belum diperiksa apakah pembulatannya sesuai konvensi `×10000` kami — dan ini jalur uang, jadi selisih diam-diam di sini mahal. Diangkat oleh prototipe 05, **belum diuji**
