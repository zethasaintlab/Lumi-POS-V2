/* Tombol yang dapat menerima `onClick`, `disabled`, dan `type="submit"`.
   ...
   Berkas ini KEMBARAN `apps/kasir/src/Tombol.tsx` dan `apps/backoffice/src/Tombol.tsx`;
   ketiga aplikasi tidak berbagi kode UI (kasir memuat PowerSync, dua lainnya
   ...
   pada `<Button>`, ketiga berkas ini dihapus bersamaan. */
