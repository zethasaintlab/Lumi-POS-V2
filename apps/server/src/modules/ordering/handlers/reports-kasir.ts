...
/** Data laporan kasir. Diekspor untuk dipakai `GET /reports/export`. */
export async function ambilKasir(
  ...
  return {
    async getCashierReport(req: FastifyRequest) {
      ...
      return withTenantTransaction(pool, tenantId, async (client) => {
        ...
        return { from, to, outletId, kasir: await ambilKasir(client, { from, to, outletId }) };
      });
    },
  };
}
